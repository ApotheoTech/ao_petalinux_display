...
#
# ao_usb_petalinux.tcl: Tcl script for re-creating project 'ao_usb_petalinux'
#
...
set _xil_proj_name_ "ao_usb_petalinux"
...
set script_file "ao_usb_petalinux.tcl"
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xck26-sfvc784-2LV-c -quiet -force
...
set_property -name "top" -value "ex_usb_wrapper" -objects $obj
...
# Proc to create BD ex_usb
proc cr_bd_ex_usb { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name ex_usb
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#I2C 1#I2C 1#PMU GPI 0#DPAUX#DPAUX#DPAUX#DPAUX#PMU GPI 5####PMU GPO 3#UART 1#UART 1##SD 1####SD 1#USB0 Reset#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB\
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0###########I2C 0#I2C 0##} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_LPD] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins ila_0/SLOT_0_AXI]
...
cr_bd_ex_usb ""
set_property REGISTERED_WITH_MANAGER "1" [get_files ex_usb.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files ex_usb.bd ] 


# Create wrapper file for ex_usb.bd
make_wrapper -files [get_files ex_usb.bd] -import -top
